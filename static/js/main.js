...
let progressEndValue = pendingqty;
let progressEndValue1 = shippedqtyper;
let progressEndValue2 = notshippedqtyper;
let progressEndValue3 = arrivedqtyper;
let progressEndValue4 = clearedqtyper;
let progressEndValue5 = pendingper;
let progressEndValue6 = shippedpriceper;
let progressEndValue7 = notshippedpriceper;
let progressEndValue8 = arrivedpriceper;
let progressEndValue9 = clearedpriceper;
...
(function() {
  /* Set the current date as the due date */
  var due_date = new Date();
  var days_deadline = 5; // Set the deadline to 5 days
